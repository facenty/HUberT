...
import com.hyper.ubertransport.my_account.usable.MyAccountAdapter;
import com.hyper.ubertransport.my_account.usable.UserData;
...
//this line shows back button
    ...
    private void updateRecycleView() {
        ...
        String addressStringBuilder = userInfo.getAdress().getFlat() +
                " " +
                userInfo.getAdress().getStreet() +
                ", " +
                userInfo.getAdress().getCity();
        list.add(new UserData(getString(R.string.address), addressStringBuilder, new AddressChangedFragment()));
        showRecycleView();
        hideProgressBar();
