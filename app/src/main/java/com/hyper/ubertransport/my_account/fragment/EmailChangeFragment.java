...
public class EmailChangeFragment extends Fragment implements Validable, RegistrationFragmentInterface {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        TextView headerView = view.findViewById(R.id.createAcoount3);
        TextView subheaderView = view.findViewById(R.id.username_password);
        ...
        TextInputLayout repeatPasswordLayout = view.findViewById(R.id.repeatpassword_textinput_layout);
